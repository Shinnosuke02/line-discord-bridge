...
class MediaService {
  ...
  /**
   * Instagram画像を処理
   * @param {Object} message - Instagram画像メッセージ
   * @returns {Object} 処理結果
   */
  ...
  /**
   * Instagram動画を処理
   * @param {Object} message - Instagram動画メッセージ
   * @returns {Object} 処理結果
   */
  ...
  /**
   * Instagram音声を処理
   * @param {Object} message - Instagram音声メッセージ
   * @returns {Object} 処理結果
   */
  ...
  /**
   * Instagramファイルを処理
   * @param {Object} message - Instagramファイルメッセージ
   * @returns {Object} 処理結果
   */
  async processInstagramFile(message) {
    try {
      ...
      return {
        content: `📎 Instagramファイル: ${message.file_name}`,
      ...
      return {
        content: `📎 Instagramファイル: ${message.file_name} (処理に失敗しました)`
      };
    }
  }
